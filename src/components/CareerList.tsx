    ...
    <ul className="pt-9 flex flex-col gap-4 items-start w-180 md:pt-0 md:w-225 xl:w-100% 2xl:w-562 xl:gap-6">
      <li>
        <p className="leading-5 text-xs font-extralight text-right flex flex-col xl:flex-row xl:gap-6">
          <span className="pb-2 text-sm font-normal md:text-base xl:text-lg xl:left-6 2xl:w-64 flex-one">
            Professional development
          </span>
          <span className="2xl:w-72 xl:text-left xl:leading-6 flex-two">
      ...
      <li>
        <p className="leading-5 text-xs font-extralight text-right flex flex-col xl:flex-row xl:gap-6">
          <span className="pb-2 text-sm font-normal md:text-base xl:text-lg xl:left-6 flex flex-col xl:flex-row 2xl:w-64 xl:block flex-one">
            Teamwork
          </span>
          <span className="2xl:w-72 xl:text-left xl:leading-6 flex-two">
